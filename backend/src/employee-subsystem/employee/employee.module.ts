...
@Module({
  ...
  providers: [EmployeeService, EmployeeProfileRepository, EmployeeProfileChangeRequestRepository],
  exports: [MongooseModule, EmployeeProfileRepository, EmployeeProfileChangeRequestRepository],
})
